...
//   return (
//     <div className="flex-1 w-333 h-full p-14 bg-gray-100 dark:bg-gray-700">
...
//             className="pl-10 pr-4 py-2 w-full rounded-md border bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-white focus:outline-none"
//           />
//         </div>
//         <div>
//           <select
