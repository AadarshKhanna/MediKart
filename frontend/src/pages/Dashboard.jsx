...
//   const generateRandomData = () => Array.from({ length: 12 }, () => Math.floor(Math.random() * 200) + 30);
...
//   const stats = [
//     { key: "sales", title: "Total Sales", value: "$250,000", icon: <FaMoneyBillWave size={30} />, color: "bg-green-500" },
//     { key: "orders", title: "Total Orders", value: "11,300", icon: <FaShoppingCart size={30} />, color: "bg-blue-500" },
//     { key: "medicines", title: "Total Medicines", value: "1,520", icon: <FaPills size={30} />, color: "bg-purple-500" },
//     { key: "customers", title: "Customers", value: "8,130", icon: <FaUsers size={30} />, color: "bg-orange-500" },
//   ];
...
//           <button onClick={() => setGraphType("line")} className="px-4 py-2 bg-blue-500 text-white rounded-md">Line</button>
//           <button onClick={() => setGraphType("bar")} className="px-4 py-2 bg-green-500 text-white rounded-md">Bar</button>
//         </div>
//       </div>
...
//           {stats.find((stat) => stat.key === selectedMetric)?.title} Overview ({selectedYear})
//         </h2>
//         {graphType === "line" ? <Line data={chartData} /> : <Bar id={`bar-chart-${selectedMetric}-${selectedYear}`} data={chartData} />
